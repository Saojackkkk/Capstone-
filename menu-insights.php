...
<head>
  ...
  <title>GastroTrack - Menu Insights</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="nav" aria-label="Main navigation">
      ...
      <a class="active" href="menu-insights.php"><span>Menu Insights</span></a>
    </nav>
  ...
  <main class="main">
    <div style="display: flex; align-items: center; justify-content: center; min-height: 60vh; flex-direction: column; gap: 20px;">
      <h1 style="font-size: 48px; color: var(--text-muted); margin: 0;">🍽️</h1>
      <h2 style="color: var(--text-primary); margin: 0;">Menu Insights</h2>
