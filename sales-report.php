...
<head>
  ...
  <title>GastroTrack - Sales Report</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="nav" aria-label="Main navigation">
      ...
      <a class="active" href="sales-report.php"><span>Sales Report</span></a>
  ...
  <main class="main">
    <div style="display: flex; align-items: center; justify-content: center; min-height: 60vh; flex-direction: column; gap: 20px;">
      ...
      <h2 style="color: var(--text-primary); margin: 0;">Sales Report</h2>
