...
<head>
  ...
  <title>GastroTrack - Suggestions</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="nav" aria-label="Main navigation">
      ...
      <a class="active" href="suggestions.php"><span>Suggestions</span></a>
  ...
  <!-- MAIN -->
  <main class="main suggestions-main">
    <!-- Page Header -->
    <div class="page-header">
      <h1>Suggestions and analysis by GastroTrack</h1>
      <button class="btn-generate" onclick="generateSuggestions()">
    ...
    <div class="suggestions-container" id="suggestionsContainer">
      <!-- Suggestion cards will be generated by JavaScript -->
    </div>
  </main>
